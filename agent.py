...
Обзор данных (внутри раздела обычный текст, БЕЗ markdown-символов, таких как: **, *, ```, `)
Ключевые метрики (внутри раздела обычный текст, БЕЗ markdown-символов, таких как: **, *, ```, `)
Инсайды (внутри раздела обычный текст, БЕЗ markdown-символов, таких как: **, *, ```, `)
Качество данных и аномалии (внутри раздела обычный текст, БЕЗ markdown-символов, таких как: **, *, ```, `)
Выводы и рекомендации (внутри раздела обычный текст, БЕЗ markdown-символов, таких как: **, *, ```, `)
